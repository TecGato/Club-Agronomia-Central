...
export const EditAthlete = ({ setEditModal, row }) => {
  ...
  return (
    <div className="min-w-min flex flex-col justify-start  items-start gap-4 border bg-white dark:border-none dark:shadow-none dark:bg-[#171717]  border-neutral-300 shadow-[0px_3px_10px_2px_rgb(0_0_0_/_13%)] px-4 py-2 rounded-lg ">
