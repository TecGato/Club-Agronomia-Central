...
export const SteeringCommitteePreview = () => {
  ...
  return (
    <>
      <div className="w-full col-span-2 min-h-[192px] sm:h-[200px] sm:w-[250px] lg:w-full xl:w-full flex flex-col justify-start  items-start gap-4 border bg-white border-neutral-300 dark:bg-[#2C2C2C] dark:border-none
        ...
        <div className="w-full grid grid-cols-2 gap-2 xl:grid-cols-1 xl:overflow-y-auto">
          {directives?.map(directive => {
            return (
              <Administrative name={directive.name} position={directive.position} />
            )
          } )}
