export function MatchesTable(props) {
  return (
    <div class="inline-block rounded-lg border shadow-2xl bg-gray-200 dark:bg-[#171717]  dark:border-none mb-4">
        ...
        <tbody>
          {props.matches
            ? props.matches.slice(0, 5).map((m, index) => {
                return (
                  <tr
                  class="text-xs text-gray-700 uppercase  dark:text-gray-100"
                    key={index}
                  >
