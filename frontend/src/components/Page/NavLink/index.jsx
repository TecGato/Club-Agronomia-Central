    ...
    return (
        <>
            <li className="px-1 relative group">
                ...
                {sonLinks && (
                    <ul className="z-40 w-max text-slate-100 p-4 absolute top-[calc(100%+4px)] rounded-lg scale-y-0 transition-all duration-200 origin-top group-hover:scale-y-100 hover:text-blue-600 bg-blue-900 bg-opacity-30 drop-shadow-lg">
