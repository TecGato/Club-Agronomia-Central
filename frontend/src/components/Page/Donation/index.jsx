    ...
    return (
        ...
        >
            <div className="bg-gradient-to-r from-blue-950 to-cyan-500/0 py-[16px] px-4 md:px-6 lg:px-8 rounded-lg flex lg:flex-row flex-col justify-start lg:justify-between  lg:items-center ">
                ...
                <button onClick={visibleContributions} className="w-48 h-12 mt-4 lg:mt-0 flex bg-gray-100 hover:bg-[#fbbf24] transition duration-300 ease-in-out text-gray-900 rounded font-bold text-lg leading-[14px] justify-center items-center text-center" type="button">
