...
export function Donation({ visibleContributions }) {
    return (
        <div className="bg-gradient-to-r from-blue-950 to-cyan-500/50 m-2 py-[16px] px-4 md:px-6 lg:px-8 rounded-lg flex lg:flex-row flex-col justify-start lg:justify-between  lg:items-center ">
            <div className="flex justify-start items-start flex-col">
                ...
                <p className="mt-2 lg:w-5/6 text-white font-normal text-sm leading-[21px]">
                    "Únete a nuestra campaña de donación para apoyar a nuestro club deportivo".
                </p>
            </div>
            <button onClick={visibleContributions} className="w-48 h-12 mt-4 lg:mt-0 flex bg-white bg-[#fef3c7] hover:bg-[#fbbf24] text-gray-900 rounded font-bold text-lg leading-[14px] justify-center items-center text-center" type="button">
