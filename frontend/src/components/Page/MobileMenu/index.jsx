...
export function MobileMenu({ openMenu }) {
  ...
  return (
    <section
      className={`z-40 w-full h-screen text-slate-100 bg-blue-900 backdrop-filter backdrop-blur-lg bg-opacity-80 top-0 left-0 fixed transition-all duration-500 [clip-path:circle(0%_at_100%_0%)] ${
        ...
        <ul className="w-3/4">
          ...
          {clubOpen && (
            <div className="mb-2 ml-5 transition-all duration-100 animate-[openMobileMenu_0.1s_ease] origin-top">
              ...
              />
              <NavLink text={'Historia'} link={'/club/historia'} />
              <NavLink text={'Instalaciones'} link={'/club/instalaciones'} />
              <NavLink
          ...
          {sportsOpen && (
            <div className="mb-2 ml-5 transition-all duration-100 animate-[openMobileMenu_0.1s_ease] origin-top">
              <NavLink text={'Ajedrez'} link={'/deportes/ajedrez'} />
              <NavLink
                text={'Fútbol Infantil'}
                link={'/deportes/futbol-infantil'}
              />
              <NavLink text={'Futsal'} link={'/deportes/futsal'} />
              <NavLink
                text={'Futsal Femenino'}
                link={'/deportes/futsal-femenino'}
              />
              <NavLink text={'Taekwondo'} link={'/deportes/taekwondo'} />
              <NavLink
