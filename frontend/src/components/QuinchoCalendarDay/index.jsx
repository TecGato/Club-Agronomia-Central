    ...
    return(
        <div>
            ...
            <div class="relative flex flex-col bg-white group">
                        ...
                        <span class="mx-2 my-1 text-xs font-bold">Fecha reserva: {props.date}</span>
                        <div class="flex flex-col px-1 py-1 overflow-auto">
                            <span class="ml-2 font-small leading-none truncate">id: {props.id}</span>
                            <span class="ml-2 font-small leading-none truncate">Estado: {props.state}</span>
                            <button class="flex items-center flex-shrink-0 h-5 px-1 text-xs hover:bg-gray-200">
                                ...
                                <span class="ml-2 font-light leading-none">{props.beg_time}</span>
                                <span class="ml-2 font-medium leading-none truncate">{props.name}</span>
                            </button>
