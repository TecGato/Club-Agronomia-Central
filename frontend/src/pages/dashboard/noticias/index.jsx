import { Layout, FormNews, FormModifyNews, ButtonEditNews, ButtonDeleteNews, ButtonCreateNews, Loader } from '@/components/Dashboard';
...
export default function News() {
  const { newsGlobal } = useContext(AppContext);
