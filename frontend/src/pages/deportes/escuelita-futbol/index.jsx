            ...
            <div  className="m-4 grid md:grid-cols-3">
                <div className='md:rounded-l-lg bg-zinc-100 col-span-1 grid'>
                    <p className="text-base text-gray-700 leading-6 p-7 place-self-center">
                        Todos los <strong>martes y viernes de 17.00hs a 18.00hs </strong>, llevamos a cabo en nuestra institución “El Jardín De Futbol”, una actividad deportiva para <strong>niños y niñas de 3 a 5 años.</strong> Que tiene como objetivo, iniciar a los mas pequeños en el mundo del deporte.
                    </p>
                    <img 
