  ...
  return (
    <Layout title='Baby Futbol' image='https://img.freepik.com/vector-gratis/balon-futbol-pictograma-red_1284-11698.jpg?size=626&ext=jpg&ga=GA1.1.1228025790.1681327921&semt=sph'>
      ...
      <div className="grid grid-cols-1 grid-rows-9 md:grid-cols-2 place-items-center">
        ...
        <p className='text-base text-gray-700 leading-6 p-7 m-5'>Por más de 40 años el club compite en baby futbol, en los primeros años en liga argentina, pasando por FAFI y actualmente en FEFI. El baby futbol es una actividad tanto a niños como a familiares que disfrutan de hermosas jornadas viendo crecer y divertir a sus seres queridos.</p>
        ...
        <p className='text-base text-gray-700 leading-6 p-7 m-5'>Este deporte se realiza con chicos <strong>desde los 6 hasta los 13 años</strong>, que encuentran en el mismo un sano espacio de recreación e iniciación en el deporte, como también medición de aptitudes deportivas contra otros niños de similar edad.</p>
        ...
        <p className='text-base text-gray-700 leading-6 p-7 m-5'>Las tiras selectivo matutino y color practican los martes y viernes <strong>de 18.00hs a 19.00</strong> categorías 2017/2016/2015, <strong>de 19.00hs a 20.00hs</strong> categorías 2014/2013, <strong>de 20.00hs a 21.00hs</strong> categorías 2012/2011/2010, las mismas son dictadas por los profes <em>Diego, Gonzalo, Román, Lucas</em></p>

        <p className='text-base text-gray-700 leading-6 p-7 m-5'>La tira de letra practica los <strong>lunes y miércoles de 17.00hs a 18.00hs</strong> categorías 2016/2015 <strong>, de 18.00hs a 19.00hs</strong> categorías 2014/2013, <strong>de 19.00hs a 20.00hs</strong> las categorías 2012/2011/2010, con los profes <em>Juan y Julián</em>.</p>
