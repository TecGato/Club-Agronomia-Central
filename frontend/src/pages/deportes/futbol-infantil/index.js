...
export default function FutInF() {
  return (
    ...
    //     <div className='flex justify-center items-center bg-teal-100 rounded-full'>
    ...
    //     </div>
    //     <img src='https://img.freepik.com/vector-gratis/pack-futbolista-dibujos-animados_23-2149034184.jpg?w=740&t=st=1681342606~exp=1681343206~hmac=03db0b6bcd6a97fcd2e74a1446b1f54ef3d87f5f2d9cb4c76584dcda9b678504' alt='futbol infantil' loading='lazy' className='w-full' />
    //     <div className='flex justify-center items-center bg-teal-100 rounded-full'>
    ...
    //     </div>
    //     <img src='https://img.freepik.com/vector-gratis/jugadores-futbol-dibujos-animados_23-2149034181.jpg?size=626&ext=jpg&ga=GA1.2.1228025790.1681327921&semt=ais' alt='futbol infantil' loading='lazy' className='w-full' />
    //     <div className='flex justify-center items-center bg-teal-100 rounded-full'> 
