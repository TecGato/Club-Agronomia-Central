        ...
        >
            <div className="m-4 grid md:grid-cols-5">
                <p className="text-base text-gray-700 dark:text-slate-100 leading-6 p-5 max-w-xl col-span-3">
                    Desde principios del año pasado, el club sumó el entrenamiento exclusivo para arqueros, donde se fomenta el desarrollo físico y mental a través de ejercicios de coordinación. <strong>no hay límites de edad.</strong>
                </p>
                <img
                ...
                />
                <div class="col-span-2 max-h-96 p-5 bg-[#031936] dark:bg-[#353434b4] md:rounded-r-lg flex items-center justify-center h-screen">
