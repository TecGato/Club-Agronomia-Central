        ...
        <div className=''>
          <div className='flex flex-col'>
              ...
              <div>
                <div className='md:flex'>
                  <p className='text-justify m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                    En una piecita de la calle chorroarin 632, alrededor de una
                    mesa de pino, y a la luz de una lampara a petróleo, se
                    reunió el 11 de diciembre de 1928, un grupo de jóvenes del
                    barrio, para dejar constituido un club deportivo.
                  </p>
                  <p className='text-justify m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                    Así nació el club social y deportivo agronomía central.
                    Durante dos años, el núcleo fundador paseo los prestigios de
                    la institución por todas las canchas de futbol improvisadas
                    en los baldíos de la ciudad.
                  </p>
                  <p className='text-justify m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                    En 1930 realizaron su fusión con el club villa modelo,
                    eligiendo para dirigir los destinos de la nueva entidad, a
                    la comisión directiva integrada por los señores: Mirabelli,
                    Collazo, Gama de santis, Repetto, Placido, Felice,
            ...
            {clickedButton === '2' && (
              <div className=''>
                <p className='text-justify m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                  Hasta 1933, el club ocupo una casita en la esquina de las
                  calles Chorroarin y Andonaegui. Entonces, otros deportes
                  comenzaron a ejercer su seducción en los asociados, y poco a
                  poco la práctica del basquetball y del tenis fue desalojando
                  al futbol. Contemporáneamente fue tomando impulso la actividad
                  social en la institución, afirmándose con el ingreso de las
                  primeras socias. El local pronto resulto pequeño y, así fue
                  necesario mudarse a la finca de la calle Bucareli 964, primero
                  y Bauness 931 después. La comisión directiva que se hizo cargo
                  de los destinos del club en 1930, al realizarse la fusión con
                  el club villa modelo. Finalmente llego 1936 y con la más
                  importante de las innovaciones para el club: la adquisición de
                  la casa propia. Las autoridades de la entidad compraron un
                  amplio solar en la calle Bauness 958 e hicieron construir allí
                  un cuerpo de edificio, que consta de dos salas, donde se
                  instalaron las oficinas de secretaria y la biblioteca; de un
                  amplio hall en el que funcionaban los juegos de salón, y de
                  una habitación larga, donde se hallaban los billares.
                </p>
              </div>
            )}
            ...
            {clickedButton === '3' && (
              <div className='md:grid md:grid-cols-3 gap-6 justify-items-center items-center m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                ...
                <p className='text-justify'>
                  ...
                  utilizaban como buffet en los días calurosos y templados.
                  Sobre tres lotes contiguos fueron habilitadas las canchas de
                  basquet, tennis, pelota y bochas. Las instalaciones propias se
                  completaban con dos amplias pistas de baile, y se proyecta en
                  ese momento una cancha cerrada de pelota, que además serviría
                  como salón de baile. En ese periodo la comisión directiva
                  estaba integrada por el señor Alfonso Rodriguez, a quienes
                  secundaban el secretario Carlos Pozzi, el prosecretario Zamora
                  Casas y el tesorero Osvaldo Borghi.
                </p>
              ...
              <div className='md:grid grid-cols-2 gap-6 justify-items-center items-center m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                <figure>
                  ...
                  <figcaption className='text-justify'>
                    ...
                    especial el básquet donde llego a jugar en la liga de
                    capital y el futbol.
                  </figcaption>
                </figure>
                <figure>
                  ...
                  <figcaption className='text-justify'>
                    Tambien club se caracterizó por festejar los carnavales con
                    distintas murgas de los barrios y sus famosos campeonatos de
                    baile y a la vez torneos de papi futbol, donde se anotan
                    equipos de las cercanías.
                  </figcaption>
                </figure>
              </div>
            )}
            ...
            {clickedButton === '5' && (
              <div className='flex flex-col items-center gap-6 m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                <p>
                  Luego en el año 1983 se acercaron al club “el turco” Balouz y
                  Jose Rucci, con un proyecto de comenzar el Baby Futbol en el
                  club donde jugarían chicos entre 6 años y 13 años, desde ahí
                  se dio comienzo a lo que al día de hoy se mantiene de forma
            ...
            {clickedButton === '7' && (
              <p className='text-justify m-1 p-2 md:p-4 md:items-center lg:p-6 xl:p-8'>
                Hoy en día el club se ha desarrollado notablemente, donde además
                de las actividades de Futbol, también se practican otras
                actividades como Ajedrez, Touch Ball y Taekwondo, además el club
                cuenta con un quincho con capacidad para 50 personas, un buffet
                económico y un Salón de Fiestas con capacidad para 120 personas,
                todo esto no se podría haber alcanzado sin la constante ayuda de
                las distintas generaciones que pasaron por nuestro club, siempre
                ad honorem buscando el crecimiento constante para llegar a hoy
                en día a ser lo que somos.
              </p>
            )}
          </div>
        </div>
